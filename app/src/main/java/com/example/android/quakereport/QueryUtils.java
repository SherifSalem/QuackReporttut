...
//                "{\"type\":\"Feature\",\"properties\":{\"mag\":6,\"place\":\"Pacific-Antarctic Ridge\",\"time\":1451986454620,\"updated\":1459202978040,\"tz\":-540,\"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004bgk\",\"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004bgk&format=geojson\",\"felt\":0,\"cdi\":1,\"mmi\":0,\"alert\":\"green\",\"status\":\"reviewed\",\"tsunami\":0,\"sig\":554,\"net\":\"us\",\"code\":\"10004bgk\",\"ids\":\",us10004bgk,gcmt20160105093415,\",\"sources\":\",us,gcmt,\",\"types\":\",cap,dyfi,geoserve,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,\",\"nst\":null,\"dmin\":30.75,\"rms\":0.67,\"gap\":71,\"magType\":\"mww\",\"type\":\"earthquake\",\"title\":\"M 6.0 - Pacific-Antarctic Ridge\"},\"geometry\":{\"type\":\"Point\",\"coordinates\":[-136.2603,-54.2906,10]},\"id\":\"us10004bgk\"}],\"bbox\":[-153.4051,-54.2906,10,158.5463,59.6363,582.56]}";
        ...
        /**
         * Return a list of {@link Earthquackes} objects that has been built up from
         * parsing a JSON response.
         */
        private static List<Earthquackes> extractEarthquakes(String earthQuackJson) {
            ...
            List<Earthquackes> earthquakes = new ArrayList<>();
            ...
            try {
                // convert the sample json response to a JSON object
                JSONObject sampleObject = new JSONObject(earthQuackJson);

                // Get the Array of earthquackes under the sample response
                JSONArray arrayOfEarthQuackes = sampleObject.getJSONArray("features");

                //Loop throught the array of earthquackes
                for (int i = 0; i<arrayOfEarthQuackes.length(); i++){
                    //get the current earthquacke in the list
                    JSONObject currentEarthquacke = arrayOfEarthQuackes.getJSONObject(i);

                    //Access the properties object for the current earthquacke
                    JSONObject propertiesObject = currentEarthquacke.getJSONObject("properties");

                    //extract the magnitude value for each earth quack n put it in a String variable
                    double mag =  propertiesObject.getDouble("mag");

                    //extract the place value with the key place
                    ...
                    Earthquackes element = new Earthquackes(mag,place,date,url);
        ...
        public static List<Earthquackes> fetchEarthquakeData(String requestUrl) {
            ...
            List<Earthquackes> earthquakes = extractEarthquakes(jsonResponse);
        ...
        /**
         * @param urlString
         * @return new URL object from url string
         */
    private static URL createUrl(String urlString){
        ...
        /**
         * makes http request and return json reponse
         * @param url
         * @return
         */
    private static String makeHttpRequest(URL url) throws IOException{
      ...
      if (url == null){
        ...
        try {
            ...
            httpURLConnection.setConnectTimeout(15000 /* millissconds*/);
            httpURLConnection.setReadTimeout(10000 /* millissconds*/);
            httpURLConnection.setRequestMethod("GET");
            httpURLConnection.connect();
            Log.v(LOG_TAG, "" + httpURLConnection.getResponseCode());
        ...
        /**
         *converts the {@link InputStream} into a string which contain the
         * json respose from the server
         *
         */
